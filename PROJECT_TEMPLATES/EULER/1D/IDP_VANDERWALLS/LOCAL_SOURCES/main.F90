...
do n=1, size(un, 2)
  CALL write_l1(euler, un(:, n), n, "init")
end do
...
!==== For regression tests ====!
  ...
  END SUBROUTINE errors
      ...
      SUBROUTINE write_l1(euler, array, comp, str)
         ...
         CALL ns_l1_par(euler%mesh, array, norm, euler%communicator)
         WRITE(*,*) str, norm, 'comp = ', comp
