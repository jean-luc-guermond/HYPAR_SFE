MODULE mesh_data_module
  ...
  !===chain of characters that should appear in data file
   ...
   TYPE argument_mesh_info_type
      ...
      CHARACTER(len = rec_length) :: refine_order      = '=== Order of refinement ==='
...
CONTAINS
   ...
   SUBROUTINE read_mesh_info(this, opt_name)
      ...
      !=== order refinement
      CALL read_data(argument_data%refine_order, this%refine_order, opt_add=this%nb_refinement>0, opt_name=opt_name)
   ...
   SUBROUTINE copy_mesh_info(this, info_bis)
      ...
      this%refine_order     = info_bis%refine_order
